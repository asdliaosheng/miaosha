...
public class CodeMsgVO {
    ...
    public static CodeMsgVO PRODUCT_CREATE_ERROR = new CodeMsgVO(500302, "创建或更新秒杀商品失败");
    public static CodeMsgVO PRODUCT_LIST_SEARCH_ERROR = new CodeMsgVO(500303, "查询秒杀商品列表失败");
    //订单模块 5004XX
